...
vim.api.nvim_set_keymap('n', '?', ':noh <enter>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', 'H', ':bp <enter>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'L', ':bn <enter>', { noremap = true, silent = true })
...
--indent
vim.api.nvim_set_keymap('v', '>', '>><Esc>gv', { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', '<', '<<<Esc>gv', { noremap = true, silent = true })

-- tab
vim.api.nvim_set_keymap('n', '<C-h>', ':tabprevious<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-j>', ':tabnew<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-k>', ':tabclose<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('v', '<C-s>', ':lua sum_column()<CR>', { noremap = true, silent = true })
...
-- copy quickmark
vim.api.nvim_set_keymap('n', '<C-y>', 'g_F|lvg_y', { noremap = true, silent = true })
-- copy ascii
vim.api.nvim_set_keymap('n', '<C-i>', [[:let @+=system("awk -F'|' '{print $NF}' \| tr ' ' '\\n'", getline('.'))<CR>]], { noremap = true, silent = true })

-- :nnoremap <F, silent = true2> :let @+=system("awk -F'|' '{print $NF}' \| tr ' ' '\\n'", getline('.'))<CR>

--replace
vim.api.nvim_set_keymap('n', '<C-/>', ':%s///g<Left><Left>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', '/', 'y/<C-R>=escape(@",\'/\\\')<CR><CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', '<C-/>', 'y:%s/<C-R>=escape(@",\'/\\\')<CR>//g<Left><Left>', { noremap = true, silent = true })

--save
vim.api.nvim_set_keymap('n', '<C-s>', ':w <enter>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '<C-s>', '<esc> <esc> :w <enter>', { noremap = true, silent = true })

--exit
vim.api.nvim_set_keymap('n', '<C-q>', ':q <enter>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '<C-q>', '<ESC> :q <enter>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('t', '<C-q>', '<C-\\><C-n>', { noremap = true, silent = true })

--tags
vim.api.nvim_set_keymap('n', 'gt', ':tag <c-r>=expand("<cword>")<cr> <enter>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', '<C-f>', ':lua superformat()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', '<C-f>', ":lua vim.lsp.buf.range_formatting()<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap('x', '<C-f>', ":lua vim.lsp.buf.range_formatting()<CR>", { noremap = true, silent = true })

--netrw
-- vim.api.nvim_set_keymap('n', 'ee', ':Lexplore <CR>', { noremap = true, silent = true })

...
vim.keymap.set('n', '?', ':noh <enter>', { desc = '' })
...
vim.keymap.set('n', 'H', ':bp <enter>', { desc = '' })
vim.keymap.set('n', 'L', ':bn <enter>', { desc = '' })
...
vim.keymap.set('n', '<C-f>', ':lua superformat()<CR>', { desc = '' })
vim.keymap.set('v', '<C-f>', ":lua vim.lsp.buf.range_formatting()<CR>", { desc = '' })
vim.keymap.set('x', '<C-f>', ":lua vim.lsp.buf.range_formatting()<CR>", { desc = '' })

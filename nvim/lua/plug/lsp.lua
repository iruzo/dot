return {

  {
    ...
    config = function()
      ...
      vim.keymap.set('n',          'gm',    ':lua vim.lsp.buf.hover()<CR>',             { noremap = true, silent=true })
      vim.keymap.set('n',          'ge',    ':lua vim.lsp.buf.rename()<CR>',            { noremap = true, silent=true })
      ...
      vim.api.nvim_set_keymap('x', '<C-a>', ':lua vim.lsp.buf.range_code_action()<CR>', { noremap = true, silent=true })
      vim.api.nvim_set_keymap('n', '<M-d>', ':lua vim.diagnostic.open_float()<CR>',     { noremap = true, silent=true })
      vim.api.nvim_set_keymap('n', '<M-p>', ':lua vim.diagnostic.goto_prev()<CR>',      { noremap = true, silent=true })
      vim.api.nvim_set_keymap('n', '<M-n>', ':lua vim.diagnostic.goto_next()<CR>',      { noremap = true, silent=true })

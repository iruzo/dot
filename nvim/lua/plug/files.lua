    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('User', {
        ...
        callback = function(args)
          vim.keymap.set('n', 'gl', open_with_default_app, { buffer = args.buf, desc = "Open with default app" })
        end,
      })
      ...
      vim.api.nvim_create_autocmd('User', {
        pattern = 'MiniFilesBufferCreate',
        callback = function(args)
          vim.keymap.set('n', '<leader>l', open_current_directory_in_file_explorer, { buffer = args.buf, desc = "Open current directory in file browser" })
        end,
      })
